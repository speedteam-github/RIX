...
local start = [[سلام
`/bold متن`
یه متن به شکل  *bold* تحویل میده

`/italic text`
یه متن به شکل  _italic_ تحویل میده

`/link url text`
هایپرلینک کردن متن

`/code text`
یه متن به شکل `code` تحویل میده


*دستورات Channel یا همون کانال*
*ربات رو در کانال ها به عنوان ادمین ادد کنید و از این دستورات استفاده کنید*

`/boldch @channelusername text`
ارسال میکند متن*bold* به کانال

`/italicch @channelusername text`
ارسال میکند متن _italic_ به کانال

`/linkch @channelusername url text`
ارسال میکنید متن لینک دار(هایپرلینک) به کانال

`/codech @channelusername text`
ارسال میکنید متن `code` به کانال


*بقیه دستورات Other*

*sticker to photo* 
_ارسال میکند یه استیکر_
